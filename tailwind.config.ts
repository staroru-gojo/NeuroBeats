  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // NeuroBeats custom colors
        orange: {
          DEFAULT: "hsl(var(--deep-orange))",
          glow: "hsl(var(--deep-orange-glow))",
        },
        charcoal: {
      ...
      boxShadow: {
        ...
        'glow-sm': '0 0 10px rgb(255 107 0 / 0.3)',
        'glow': '0 0 20px rgb(255 107 0 / 0.4)',
        'glow-lg': '0 0 30px rgb(255 107 0 / 0.5)',
      },
      spacing: {
        // Additional spacing values for better control
        '18': '4.5rem',
        '88': '22rem',
        '100': '25rem',
        '112': '28rem',
      ...
      animation: {
        ...
        "slide-up-delayed": "slide-up-delayed 1s cubic-bezier(0.4, 0, 0.2, 1) forwards",
